			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="panel panel-default">
						<div class="panel-body status">
							...
							<ul class="comments">
								<li>
									<img src="<?php echo ASSETS_URL; ?>/img/avatars/juan.png" alt="img" class="online">
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="panel panel-default">
						<div class="panel-body status">
							<div class="who clearfix">
								<img src="<?php echo ASSETS_URL; ?>/img/avatars/juan.png" alt="img" class="busy">
						...
						<div class="panel-body status">
							...
							<div id="chat-body" class="chat-body custom-scroll">
								<ul>
									...
									<li class="message">
										<img src="<?php echo ASSETS_URL; ?>/img/avatars/juan.png" class="online" alt="">
										<div class="message-text">
											<time>
												2014-01-13
