...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	class="fixed-ribbon  desktop-detected  fixed-header fixed-navigation    pace-done smart-style-1"
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/avatars/juan.png" alt="John Doe" class="online" />
								</a>
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-co" alt="United States"> <span> Español (CO) </span> <i class="fa fa-angle-down"></i> </a>
								<ul class="dropdown-menu pull-right">
									<li class="active">
