		...
		<div id="content">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				  <h1 class="page-title txt-color-blueDark"><em class="fa-fw fa fa-home"></em> Inicio <span>&gt; Panel de control</span></h1>
				</div>
								...
								<div class="widget-body widget-hide-overflow no-padding">
									...
									<div id="chat-container">
										...
										<div class="chat-list-body custom-scroll">
											<ul id="chat-users">
												...
												<li>
													<a href="javascript:void(0);"><img src="img/avatars/juan.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
												</li>
												<li>
									...
									<div id="chat-body" class="chat-body custom-scroll">
										<ul>
											...
											<li class="message">
												<img src="img/avatars/juan.png" class="online" alt="">
												<div class="message-text">
													<time>
														2014-01-13
